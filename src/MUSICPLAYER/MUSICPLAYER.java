...
public class MUSICPLAYER extends javax.swing.JFrame {
   ...
   public MUSICPLAYER() {
       ...
       javax.swing.Timer timer = new javax.swing.Timer(1000, new ActionListener(){
           ...
           public void actionPerformed(ActionEvent e) {
               ...
               {
                   if(!MUSICPLAYER.a.isAlive() && !filePlaylist.isEmpty())
                   {
                       a = new Thread ()
                       {
                           public void run()
   ...
   private void jButtonAddToPlaylistActionPerformed(java.awt.event.ActionEvent evt) {                                                     
   ...
   private void jButtonNextSongActionPerformed(java.awt.event.ActionEvent evt) {                                                
   ...
   private void jButtonPrintPlaylistActionPerformed(java.awt.event.ActionEvent evt) {                                                     
       this.ReadPlaylistFile();
   ...
   private void jTextFieldPlayingFileActionPerformed(java.awt.event.ActionEvent evt) {                                                      

   }                                                     

   private void jButtonPreviousSongActionPerformed(java.awt.event.ActionEvent evt) {                                                    
   ...
   private void jButtonRepeatModeActionPerformed(java.awt.event.ActionEvent evt) {                                                  
   ...
   private void jButtonShuffleActionPerformed(java.awt.event.ActionEvent evt) {                                               
       if(filePlaylist!=null)
       {
   ...
   private void jButtonClearPlaylistActionPerformed(java.awt.event.ActionEvent evt) {                                                     
       if(filePlaylist!=null)
       {
           filePlaylist.clear();
           this.WritePlaylistFile();
